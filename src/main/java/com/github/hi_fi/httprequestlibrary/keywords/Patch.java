...
public class Patch {
	...
	public ResponseData patchRequest(String alias, String uri, String...params) {
		...
		Map<String, String> headers = Robot.getParamsValue(params, 1, (Map<String, String>) new HashMap<String, String>());
		Map<String, String> files = Robot.getParamsValue(params, 2, (Map<String, String>) new HashMap<String, String>());
